...
var getNeighbours = function (x, y, size) {
	var neibs = []
...
function findPath (grid, size, start_cell, end_cell, wall_cells) {
	var closed_list = []
	var open_list   = []
	...
	var doNeighbours = function (parent_cell) {
		...
		neigbs = getNeighbours(parent_cell[0], parent_cell[1], size)
...
var a_star = function () {}
a_star.getPath = function (size, start_cell, end_cell, wall_cells) {
	...
	findPath(grid, size, start_cell, end_cell, wall_cells)
